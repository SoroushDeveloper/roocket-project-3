...
export default function EditPost({showModal, hideModalHandler, post, updatePostHandler}) {
        ...
        if (title !== "") {
            ...
            axios.put(url, data)
                .then(function (response) {
                    updatePostHandler(post, response.data);
                        ...
                        <div className="relative w-auto my-6 mx-auto max-w-3xl">
                            <div
                                ...
                                <div className="relative p-6 flex-auto w-96">
                                    <input type="text" id="title" onChange={inputHandler} value={title}
                                ...
                                <div
                                    ...
                                    <div className="flex space-x-2">
                                        ...
                                        <Save onClickHandler={updateHandler}/>
                                    </div>
                                </div>
                            </div>
                        </div>
